...
sl_mean <- mean(data_no_irrelevant_columns$sl)
activity_mean <- mean(data_no_irrelevant_columns$activity)
sl_se <- var(data_no_irrelevant_columns$sl)
activity_se <- var(data_no_irrelevant_columns$activity)
...
data_clean <- data_no_irrelevant_columns %>% group_by(species, treatment) %>% mutate(sample_size = length(sl), mean_sl = sl_mean, standared_error_sl = sl_se, mean_activity = activity_mean, standared_error_activity = activity_se)
