...
data_clean <- data_no_irrelevant_columns %>% group_by(species, treatment) %>% mutate(sample_size = length(activity),  mean_activity = mean(activity), standard_error_activity = var(activity))
